...
parser.add_argument('--begin', default=0, type=int, metavar='N',
                    help='the index  of begining sample to test')
parser.add_argument('--end', default=0, type=int, metavar='N',
                    help='the index  of end sample to test')
